...
// POST = REAL EXECUTION OF AN APPROVED CANDIDATE
//
// Capital: 5 USDC
// Slots: 4 x 1 USDC
// Reserve: 1 USDC
...
async function analyzeSystem(req) {
  ...
  /*
    بعض إصدارات signal-agent
    ترجع بيانات السوق خارج signal.
    ندمجها هنا إن كانت موجودة.
  */
